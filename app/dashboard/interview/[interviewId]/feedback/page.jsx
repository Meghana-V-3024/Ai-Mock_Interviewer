       ...
       my-2 text-left gap-7"
            ...
            <CollapsibleContent>
              <div className="flex flex-col gap-2">
                ...
                <h2 className="p-2 rounded-lg border bg-red-50 text-sm text-red-900">
                  <strong>Your Answer: </strong>
                  {item.userAns}
                </h2>
                <h2 className="p-2 rounded-lg border bg-green-50 text-sm text-green-900">
                  <strong>Correct Answer: </strong>
                  {item.correctAns}
                </h2>
                <h2 className="p-2 rounded-lg border bg-blue-50 text-sm text-primary">
